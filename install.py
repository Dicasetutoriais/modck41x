...
rDownloadURL = {"main": "https://bitbucket.org/gabrielssh/modck41/downloads/main_xtreamcodes_reborn.tar.gz", "sub": "https://bitbucket.org/gabrielssh/modck41/downloads/sub_xtreamcodes_reborn.tar.gz"}
...
def prepare(rType="MAIN"):
    ...
    os.system("wget -q -O /tmp/libpng12.deb https://bitbucket.org/gabrielssh/modck41/downloads/libpng12-0_1.2.54-1ubuntu1_amd64.deb")
...
def configure():
    ...
    os.system("sudo wget -q https://bitbucket.org/gabrielssh/modck41/downloads/youtube-dl -O /usr/local/bin/youtube-dl")
